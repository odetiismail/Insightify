  ...
  useEffect(() => {
    const getUsersData = async () => {
      try {
        ...
        setPendingItem(userData.filter((item) => item.orderStatus === "ACCEPTED" && item.orderAcceptedTime !== null));
        setFinish(userData.filter((item) => item.orderFinishedTime !== null));
      } catch (error) {
    ...
    <>
      ...
      <div className="orders">
        ...
        <div className="pendingdiv">
          ...
          <div>
            <p id="seemore">
              <Link to="/pendingorders" className="text-decoration-none text-dark">See more</Link>
            </p>
          </div>
        </div>
        ...
        <div>
          <div className="pendingdiv">
            ...
            <div>
              <p id="seemore">
                <Link to="/finishedorders" className="text-decoration-none text-dark">See more</Link>
              </p>
            </div>
          </div>
          <div className="ordershistory">
            {finish.length > 0 ? (
              finish.slice(0,3).map((item, index) => (
                <div
                  className="order2"
                  key={index}
                  onClick={() => {
